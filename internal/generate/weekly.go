...

{
  ...
  "trends_diagram": "一段 mermaid 代码（不含围栏标记），用 mindmap 语法画一张本周趋势思维导图。根节点用双括号 root((本周AI趋势))。每个趋势方向作为一级分支，下面挂 2-3 个支撑事件或关键判断。用简短中文（4-12字）。总共 12-18 个节点。不用 graph 语法，必须用 mindmap 语法。",
